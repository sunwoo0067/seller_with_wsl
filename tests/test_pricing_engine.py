...
def mock_supabase_storage():
    ...
    mock_storage.get_pricing_rules.return_value = sorted([
        # 패션 카테고리 특별 규칙
        {
            ...
            'additional_costs': {'platform_fee_rate': 0.1, 'payment_fee_rate': 0.03, 'packaging_cost': 1200, 'handling_cost': 800},
            'round_to': 900,
            'is_active': True
        },
        # 저가 상품 규칙 (1만원 미만)
        {
            ...
            'additional_costs': {'platform_fee_rate': 0.1, 'payment_fee_rate': 0.03, 'packaging_cost': 1000, 'handling_cost': 500},
            'round_to': 100,
            'is_active': True
        },
        # 중가 상품 규칙 (1만원 ~ 5만원)
        ...
        # 고가 상품 규칙 (5만원 이상)
        {
            ...
            'additional_costs': {'platform_fee_rate': 0.1, 'payment_fee_rate': 0.03, 'packaging_cost': 1500, 'handling_cost': 1000},
            'round_to': 1000,
            'is_active': True
        },
