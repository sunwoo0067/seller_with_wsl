...
from dropshipping.orders.supplier.base import BaseSupplierOrderer, SupplierOrderStatus, SupplierType
    ...
    def _parse_order_response(self, xml_str: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if code == "00":  # 성공
                ...
                return {"success": True, "order_id": order_no, "message": message}
            else:
