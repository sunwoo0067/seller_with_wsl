    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "system": {
                ...
                "db": {
                    "total_queries": self.metrics.get("db.queries", Metric("", "counter")).get_value(),
                    "total_errors": self.metrics.get("db.errors", Metric("", "counter")).get_value(),
                    "latency": self.metrics.get("db.latency", Metric("", "histogram")).get_stats()
                }
            },
            "business": {
                "products": {
                    "fetched": self.metrics.get("products.fetched", Metric("", "counter")).get_value(),
                    "processed": self.metrics.get("products.processed", Metric("", "counter")).get_value(),
                    "uploaded": self.metrics.get("products.uploaded", Metric("", "counter")).get_value()
                },
                "orders": {
                    "received": self.metrics.get("orders.received", Metric("", "counter")).get_value(),
                    "processed": self.metrics.get("orders.processed", Metric("", "counter")).get_value()
                }
            },
            "ai": {
                "total_requests": self.metrics.get("ai.requests", Metric("", "counter")).get_value(),
                "total_tokens": self.metrics.get("ai.tokens_used", Metric("", "counter")).get_value(),
