...
class CoupangUploader(BaseUploader):
    ...
    async def transform_product(self, product: StandardProduct) -> Dict[str, Any]:
        ...
        coupang_data = {
            ...
            "noticeCategories": [
                {
                    ...
                    "noticeCategoryDetailNames": [
                        {"noticeCategoryDetailName": "품명", "content": product.name[:50]},
                        {
            ...
            # 상품 속성
            "attributes": [{"attributeTypeName": "수량", "attributeValueName": str(product.stock)}],
            # 판매자 상품 코드
    ...
    async def _api_request(self, method: str, path: str, **kwargs) -> Dict[str, Any]:
        ...
        if response.status_code == 200:
            ...
            return {"code": "ERROR", "message": f"API 오류: {response.status_code}"}
