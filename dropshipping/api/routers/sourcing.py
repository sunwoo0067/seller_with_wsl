...
async def get_trending_products(
    ...
    try:
        ...
        # 트렌드 분석
        trending = await analyzer.get_trending_products(
            days=period,
            category=category,
            limit=limit
        )
...
async def get_trending_keywords(
    ...
    try:
        ...
        keywords = await storage.list(
            ...
            filters=filters,
            limit=limit,
            order_by=["-search_volume", "-trend_score"]
        )
...
async def analyze_competitor(
    ...
    try:
        ...
        # 경쟁사 분석
        analysis = await monitor.analyze_competitor(
            competitor_id,
    ...
    try:
        ...
        dashboard_data = {
            ...
            "summary": {
                ...
                "trending_keywords": await storage.count(
                    "keywords",
                    filters={"is_trending": True}
                )
            },
